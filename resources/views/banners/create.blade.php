<form id="form-create-banner" action="{{ route('banners.store') }}" method="POST" enctype="multipart/form-data"
    ...
    <div class="tw-flex tw-items-center tw-justify-between tw-px-6 tw-py-4 tw-border-b tw-border-gray-100 tw-bg-white">
        <div>
            <h3 class="tw-text-lg tw-font-semibold tw-text-gray-900 tw-tracking-tight">Tạo banner mới</h3>
            <p class="tw-text-sm tw-text-gray-500 tw-mt-0.5">Điền thông tin banner bên dưới.</p>
        </div>

        <div>
            <button type="submit" id="submit-create-banner"
    ...
    <div class="tw-px-6 tw-py-5 tw-bg-white tw-overflow-y-auto tw-flex-1 tw-space-y-5">
        <div>
            ...
            <input type="text" name="title" id="title" placeholder="Tiêu đề banner"
        ...
        <div>
            <label for="image_url" class="tw-block tw-text-sm tw-font-medium tw-text-gray-700 tw-mb-1.5">
                Ảnh banner <span class="tw-text-red-500">*</span>
            </label>
            <div
                ...
                <div
                    ...
                    <img id="banner-image-preview" src="" alt="Xem trước banner"
                        class="tw-w-full tw-h-full tw-object-cover tw-hidden">
                    <i id="banner-image-placeholder" class="fas fa-image tw-text-gray-300 tw-text-xl"></i>
                </div>
                <div class="tw-flex-1">
