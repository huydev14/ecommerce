                ...
                error: function (xhr) {
                    if (xhr.status === 422) {
                        ...
                        fluentToast({
                            ...
                            description: xhr.responseJSON?.msg || Lang.get('stock.system_error_description'),
                            subtitle: 'Code: ' + xhr.status,
                            actionType: 'close',
                        });
                    }
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                fluentToast({
                    ...
                    description: res.msg || Lang.get('stock.undo_success_description'),
                    actionType: 'close',
                });
            },
            error: function (xhr) {
                fluentToast({
                    ...
                    description: xhr.responseJSON?.msg || Lang.get('stock.restore_error_description'),
                    subtitle: 'Code: ' + xhr.status,
                });
            },
        });
        ...
        $.ajax({
            ...
            error: function (xhr) {
                fluentToast({
                    ...
                    description: xhr.responseJSON?.msg || Lang.get('stock.generic_error_description'),
                    subtitle: 'Code: ' + xhr.status,
                    actionType: 'close',
                });
            },
